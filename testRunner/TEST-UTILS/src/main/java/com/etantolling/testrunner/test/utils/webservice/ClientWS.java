package com.etantolling.testrunner.test.utils.webservice;
...
public class ClientWS {
	...
	public static ResponseEntity<String> call(String urlRequest, Object jsonRequest, HttpMethod httpMethod, HashMap<String, String> httpHeaderRequest) throws Exception {
	...
	public static ResponseEntity<String> call(String urlRequest, Object request, HttpMethod httpMethod, MediaType mediaType, HashMap<String, String> httpHeaderRequest) throws Exception {
