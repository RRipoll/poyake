 ...
 *
 */
public final class TransactionPort_Wasdot_Client implements ITestEventRunner {
	private static final Logger logger = LoggerFactory.getLogger(TransactionPort_Wasdot_Client.class);
	private static final QName SERVICE_NAME = new QName("http://transaction.wsdl.tcs.wsdot.fastlane.etantolling.com",
			"TransactionPortService");
	private String tennantname;

	public TransactionPort_Wasdot_Client(String tennantName) {
	}
	
	public TransactionPort_Wasdot_Client() {
	}

	public static void main(String args[]) throws java.lang.Exception {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             

		URL wsdlURL = new URL("http://localhost:9080/ws/transaction.wsdl");
		...
		TransactionPort port = ss.getTransactionPortSoap11();
		{
			...
			com.etantolling.fastlane.wsdot.tcs.wsdl.transaction.TollTransactionRequest request = new TollTransactionRequest();
			...
			com.etantolling.fastlane.wsdot.tcs.wsdl.transaction.TollTransactionResponse response = port
	...
	void sendTransaction(String appBaseUrl,String url,String json,TestParameterList params) throws JsonParseException, JsonMappingException, IOException {
		...
		for (TollTransactionRequest request : tollTransactionRequests) {
			com.etantolling.fastlane.wsdot.tcs.wsdl.transaction.TollTransactionResponse response = port.tollTransaction(request);
			try {
