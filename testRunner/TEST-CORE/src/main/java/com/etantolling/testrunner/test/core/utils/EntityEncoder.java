...
public class EntityEncoder {
	...
	static public String textEncode(String s) {

		if (null == s)
			return null;

		// s = RhinoEscaper.js_unescape("VUE%20PANORAMIQUE%2");
		...
		for (int i = 0; i < length; i++) {
			...
			/*
			 * else if (j == 8364) {
			 * buffer.append((char) 128);
			 * } else if (j == 8217) {
			 * buffer.append((char) 39);
			 * } else if (j == 8230) {
			 * buffer.append((char) 133);
			 * } else if (j == 8211) {
			 * buffer.append((char) 150);
			 * } else if (j == 8240) {
			 * buffer.append((char) 137);
			 * } else if (j == 8212) {
			 * buffer.append((char) 151);
			 * } else if (j == 8220) {
			 * buffer.append((char) 147);
			 * } else if (j == 8221) {
			 * buffer.append((char) 148);
			 * } else if (j == 8226) {
			 * buffer.append((char) 149);
			 * } else if (j == 8216) {
			 * buffer.append((char) 145);
			 * } else if (j == 8217) {
			 * buffer.append((char) 146);
			 * } else if (j == 8218) {
			 * buffer.append((char) 130);
			 * } else if (j == 8222) {
			 * buffer.append((char) 132);
			 * } else if (j == 8482) {
			 * buffer.append((char) 153);
			 * }
			 */
