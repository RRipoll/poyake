...
public class MultipleEnumRenderer implements IMTFieldRenderer {

	public MultipleEnumRenderer() {
	}
	...
	return MultipleHelper.getDescription((ListValues<IDetachedRecord>) value,mtField,locale);
	}
