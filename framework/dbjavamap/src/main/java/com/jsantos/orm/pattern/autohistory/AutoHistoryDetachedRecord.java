...
public class AutoHistoryDetachedRecord extends DetachedRecord implements IDetachedRecord{
	MTField mainFk = null;
	boolean isMainFk=true;
	
	String whereMainFkClause=" and startDate<=getPostingDate() and endDate>getPostingDate() ";
	...
	public DetachedRecord insert() {
		...
		String sql = "update " + table.getFullTableName() + " set endDate=getPostingDate() where " + mainFk.getName() + "=" + get(mainFk) + " and endDate>getPostingDate()"; 
	...
	public void update() {
		...
		String sql = "update " + table.getFullTableName() + " set endDate=:endDate where " + mainFk.getName() + "=" + get(mainFk) + " and endDate>getPostingDate()"; 
		jdbcTemplate.update(sql, namedParameters);
