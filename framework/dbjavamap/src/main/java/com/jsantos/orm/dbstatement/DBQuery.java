...
public class DBQuery {
	...
	public DQResults<IDetachedRecord> getPage(Integer pageNumber) throws SQLException {
		ListValues<IDetachedRecord> results = new ListValues<>();
		...
		DQResults<IDetachedRecord> dqResults = new DQResults<IDetachedRecord>();
