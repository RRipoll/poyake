...
public class SwaggerConfig {
	...
	private ApiInfo getApiInfo() {
		return new ApiInfo(
				...
				"1.0",
				"http://poyake/terms",
				new Contact("jsantos", "https://poyake.com", "apis@poyake.com"),
				"LICENSE",
				"LICENSE URL",
	...
	private List<SecurityReference> defaultAuth() {
		...
		List<SecurityReference> retValue= new ArrayList();
		retValue.add(new SecurityReference("mykey", authorizationScopes));
		return retValue;
	}
