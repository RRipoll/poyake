...
public class CreateTestTrips implements EventListener<Event> {
	...
	public void buildScreen(Component parent) {
		...
		mainDiv = Executions.createComponents("~./zul/poyake-roadrunner/screen/test/create_test_trips.zul", parent, null);
	...
	public void create(Event evt) {
		...
		licensePlateId = new DetachedRecord(MTroadRunnerData.VFINDVEHICLE, " customerId=" + customerId,null).getInt(MTTableVFINDVEHICLE.LICENSEPLATEID);
