...
public class LastInvoiceGridCellBuilder   implements IGridCellBuilder {
	...
	public MTField forField() {
		...
		return MTroadRunnerData.VCUSTOMERSEARCH.LASTINVOICE;
	}

	@Override
	public Component buildGridComponent(MTField field, Object value, IDetachedRecord values,Locale locale) {
		if (null != value)
			return URLKeyGridCellBuilder.createComponent(values.get(MTroadRunnerData.VCUSTOMERSEARCH.LASTINVOICEID).toString(),
					value,locale);
		return null;
	}
