...
public class MTTableCHECKPARAMEVENTDEFINITION extends com.jsantos.orm.mt.MTTable{
	...
	public static void init(){
		...
		fields.add(EVENTDEFINITIONUUID);
		{
			...
			EVENTDEFINITIONUUID.setSequence("testrunner.Seq_CheckParamEventDefinition_eventDefinitionUuid");
	...
	public MTTableCHECKPARAMEVENTDEFINITION(){
		init();
		this.tableName = "CheckParamEventDefinition";
