...
public class MTTableVUSERMULTIGROUP extends com.jsantos.orm.mt.MTTable{
	...
	public static void init(){
		...
		fields.add(INPUTUSERID);
		{
			...
			INPUTUSERID.setSequence("audit.Seq_VUserMultiGroup_inputUserId");
			INPUTUSERID.getLabels().add(new Label("SHORTLABEL","en_EN","User #"));
			INPUTUSERID.getLabels().add(new Label("SHORTLABEL","es_ES","# Usuario"));
	...
	public MTTableVUSERMULTIGROUP(){
		init();
		this.tableName = "VUserMultiGroup";
		this.schema = "audit";
