-- Generated Script file for H2 !!!
-- Generated at Wed Sep 29 14:55:37 CEST 2021 
...
CREATE SEQUENCE permission.Seq_EnuPermissionType_permissionTypeId START WITH 1000
; -- Generated Statement 

CREATE SEQUENCE permission.Seq_EnuPermissionValue_permissionValueId START WITH 1000
; -- Generated Statement 

CREATE SEQUENCE permission.Seq_Permission_permissionId START WITH 1000
; -- Generated Statement 

CREATE SEQUENCE permission.Seq_Rol_rolId START WITH 1000
; -- Generated Statement 

CREATE SEQUENCE permission.Seq_RolPermission_rolPermissionId START WITH 1000
; -- Generated Statement 

CREATE SEQUENCE permission.Seq_UserGroupRol_userGroupRolId START WITH 1000
; -- Generated Statement 
...
CREATE SEQUENCE testrunner.Seq_HttpMethod_httpMethodId START WITH 1000
; -- Generated Statement 

CREATE SEQUENCE recorder.Seq_EnuRecorderType_enuRecorderTypeId START WITH 1000
; -- Generated Statement 

CREATE SEQUENCE recorder.Seq_RecorderData_recorderDataId START WITH 1000
; -- Generated Statement 

CREATE SEQUENCE recorder.Seq_RecorderMaster_recorderMasterId START WITH 1000
; -- Generated Statement 
...
CREATE TABLE permission.EnuPermissionType(
	permissionTypeId INT NOT NULL ,
	shortCode VARCHAR(16) NOT NULL ,
	description VARCHAR(32) NOT NULL 
,CONSTRAINT PK_permission_EnuPermissionType PRIMARY KEY (permissionTypeId))
; -- Generated Statement 

CREATE TABLE permission.EnuPermissionValue(
	permissionValueId INT NOT NULL ,
	shortCode VARCHAR(16) NOT NULL ,
	description VARCHAR(32) NOT NULL 
,CONSTRAINT PK_permission_EnuPermissionValue PRIMARY KEY (permissionValueId))
; -- Generated Statement 
...
CREATE TABLE permission.Permission(
	...
	permissionTypeId INT DEFAULT 1 NOT NULL ,
	permissionValueId INT DEFAULT 2 NOT NULL 
,CONSTRAINT PK_permission_Permission PRIMARY KEY (permissionId))
; -- Generated Statement 

CREATE TABLE permission.Rol(
	rolId INT,
	shortCode VARCHAR(16) NOT NULL ,
	description VARCHAR(32) NOT NULL 
,CONSTRAINT PK_permission_Rol PRIMARY KEY (rolId))
; -- Generated Statement 

CREATE TABLE permission.RolPermission(
	rolPermissionId INT NOT NULL ,
	rolId INT DEFAULT 2 NOT NULL ,
	permissionId INT NOT NULL 
,CONSTRAINT PK_permission_RolPermission PRIMARY KEY (rolPermissionId))
; -- Generated Statement 

CREATE TABLE permission.UserGroupRol(
	userGroupRolId INT NOT NULL ,
	rolId INT NOT NULL ,
	inputUserGroupId INT NOT NULL 
,CONSTRAINT PK_permission_UserGroupRol PRIMARY KEY (userGroupRolId))
; -- Generated Statement 
...
CREATE TABLE testrunner.HttpMethod(
	httpMethodId INT,
	shortCode VARCHAR(16) NOT NULL ,
	description VARCHAR(32) NOT NULL 
,CONSTRAINT PK_testrunner_HttpMethod PRIMARY KEY (httpMethodId))
; -- Generated Statement 

CREATE TABLE recorder.EnuRecorderType(
	enuRecorderTypeId INT,
	shortCode VARCHAR(16),
	description VARCHAR(255)
,CONSTRAINT PK_recorder_EnuRecorderType PRIMARY KEY (enuRecorderTypeId))
; -- Generated Statement 

CREATE TABLE recorder.RecorderData(
	recorderDataId INT,
	recorderTypeId INT,
	postingDate TIMESTAMP DEFAULT getPostingDate() NOT NULL ,
	tableName VARCHAR(256) NOT NULL ,
	data VARCHAR NOT NULL ,
	deleted INT DEFAULT 0 NOT NULL 
,CONSTRAINT PK_recorder_RecorderData PRIMARY KEY (recorderDataId))
; -- Generated Statement 

CREATE TABLE recorder.RecorderMaster(
	recorderMasterId INT,
	postingDate TIMESTAMP DEFAULT getPostingDate() NOT NULL ,
	session VARCHAR(255) NOT NULL ,
	deleted INT DEFAULT 0 NOT NULL 
,CONSTRAINT PK_recorder_RecorderMaster PRIMARY KEY (recorderMasterId))
; -- Generated Statement 
...
insert into permission.EnuPermissionType(permissionTypeId,shortCode,description) values 
(1,'MENU','Menu')
,(3,'MTTABLE','Table')

; -- Generated Statement 

insert into permission.EnuPermissionValue(permissionValueId,shortCode,description) values 
(0,'ALL','All')
,(1,'WRITE','Write')
,(2,'READ','Read')
,(3,'NO','No')
...
insert into permission.Permission(permissionId,shortCode,description,permissionTypeId,permissionValueId) values 
('1','ADMIN_MENU','Admin Menu','1','2')
,('2','TESTRUNNER','Test Runner Permission','1','1')
,('3','CONF_EDITABLE','Conf Editable','3','2')
,('4','example.VBook','no edit for book','3','1')
,('5','testrunner.TestTree','testTree','3','2')
,('6','testrunner.StoreValuesEvent','StoreValuesEvent are not editable','3','2')
,('7','audit.UserGroup','not editable','3','2')
,('8','permission.UserGroupRol','not editable','3','2')

; -- Generated Statement 

insert into permission.Rol(rolId,shortCode,description) values 
('1','USER','User Rol')
,('2','SYS_ADMIN','Admin Rol')
,('3','ACCOUNTANT','Accountant Rol')
,('4','TR_ROL','Test Runner Rol')
,('5','CONF_EDITABLE','Conf Editable')

; -- Generated Statement 

insert into permission.RolPermission(rolPermissionId,rolId,permissionId) values 
('1','2','1')
,('2','4','2')
,('3','5','3')
,('4','2','5')
...
insert into permission.UserGroupRol(userGroupRolId,rolId,inputUserGroupId) values 
('1','2','1')
,('2','4','5')
,('3','5','1')
,('4','2','2')
...
insert into testrunner.HttpMethod(httpMethodId,shortCode,description) values 
(2,'PUT','PUT')
,(4,'DELETE','DELETE')
,(3,'POST','POST')
,(1,'GET','GET')
...
insert into recorder.EnuRecorderType(enuRecorderTypeId,shortCode,description) values 
(1,'INSERT','INSERT')
,(2,'UPDATE','UPDATE')
,(3,'DELETED','DELETED')
...
insert into config.DatagridSetting(dataGridSettingId,searchName,data,created,inputUserGroupId,inputUserId,inputSourceId) values 
('b332a351-ea23-43d1-af4a-5793d3e8ccba','AppInfoTree','{
  "dataTableName" : "config.AppInfoTree",
  "aSName" : "AppInfoTree",
  "columnConfigurations" : [ {
    "name" : "appInfoTreeId",
    "hidden" : true,
  ...
  "orderByConfigurations" : [ {
    ...
    "active" : false,
    "hidden" : false,
    "label" : "AppInfoTree.appInfoTreeId"
  }, {
    "name" : "parentAppInfoTreeId",
    "asc" : false,
    "active" : false,
    "hidden" : false,
    "label" : "AppInfoTree.parentAppInfoTreeId"
  }, {
    "name" : "description",
    "asc" : false,
    "active" : false,
...
,('5bba37a8-0072-4897-ac58-d8609ca41b8d','AppInfo','{
  "dataTableName" : "config.AppInfo",
  "aSName" : "AppInfo",
  "columnConfigurations" : [ {
    "name" : "appInfoId",
    "hidden" : false,
...
insert into config.DatagridSetting(dataGridSettingId,searchName,data,created,inputUserGroupId,inputUserId,inputSourceId) values 
('8006ea86-d092-493b-ad93-8f3d49eea017','RunTestEventDefinition','{
  "dataTableName" : "testrunner.RunTestEventDefinition",
  "aSName" : "RunTestEventDefinition",
  "columnConfigurations" : [ {
    "name" : "eventDefinitionUuid",
    "hidden" : false,
    "available" : true,
  ...
  "orderByConfigurations" : [ {
    ...
    "active" : false,
    "hidden" : false,
    "label" : "RunTestEventDefinition.eventDefinitionUuid"
  }, {
    "name" : "eventTypeId",
    "asc" : false,
    "active" : false,
    ...
    "active" : false,
    "hidden" : false,
    "label" : "RunTestEventDefinition.testId"
  }, {
    "name" : "repetitionNumber",
    "asc" : false,
    "active" : false,
    "hidden" : false,
    "label" : "RunTestEventDefinition.repetitionNumber"
  } ],
  "filterConfigurations" : [ {
    "hidden" : false,
    "operator" : "EQUAL",
...
insert into config.DatagridSetting(dataGridSettingId,searchName,data,created,inputUserGroupId,inputUserId,inputSourceId) values 
('d98d0564-3ddd-42d6-9eca-d6b45c3385f2','RecorderDefinition','{
  "dataTableName" : "testrunner.RecorderDefinition",
  "aSName" : "RecorderDefinition",
  "columnConfigurations" : [ {
    "name" : "eventDefinitionUuid",
    "hidden" : false,
    "available" : true,
  ...
  "orderByConfigurations" : [ {
    ...
    "active" : false,
    "hidden" : false,
    "label" : "RecorderDefinition.eventDefinitionUuid"
  }, {
    "name" : "eventTypeId",
    "asc" : false,
    "active" : false,
    ...
    "active" : false,
    "hidden" : false,
    "label" : "RecorderDefinition.files"
  } ],
  "filterConfigurations" : [ {
    "hidden" : false,
    "operator" : "EQUAL",
...
insert into config.DatagridSetting(dataGridSettingId,searchName,data,created,inputUserGroupId,inputUserId,inputSourceId) values 
('CHECK_PARAMETER','CheckParamEventDefinition','{
  "dataTableName" : "testrunner.CheckParamEventdefinition",
  "aSName" : "CheckParamEventDefinition",
  "columnConfigurations" : [ {
    "name" : "eventTypeId",
    "hidden" : false,
    "available" : true,
...
,('c7c3533e-d0eb-459f-8b3e-6ea58ea7ba03','CheckParameterItem','{
  "dataTableName" : "testrunner.CheckParameterItem",
  "aSName" : "CheckParameterItem",
  "columnConfigurations" : [ {
    "name" : "valueName",
    "hidden" : false,
    "available" : true,
  ...
  "orderByConfigurations" : [ {
    ...
    "active" : false,
    "hidden" : false,
    "label" : "CheckParameterItem.value"
  }, {
    "name" : "operator",
    "asc" : false,
    "active" : false,
    "hidden" : false,
    "label" : "CheckParameterItem.operator"
  }, {
    "name" : "checkValueTypeId",
    "asc" : false,
    "active" : false,
    "hidden" : false,
    "label" : "CheckParameterItem.checkValueTypeId"
  }, {
    "name" : "checkValue",
    "asc" : false,
    "active" : false,
    "hidden" : false,
    "label" : "CheckParameterItem.checkValue"
  } ],
  "filterConfigurations" : [ {
    "hidden" : false,
    "operator" : "EQUAL",
  ...
  "editConfigurations" : [ {
    ...
    "constraints" : [ "com.jsantos.custom.constraints.CheckParameterAction", "com.jsantos.custom.constraints.DefaultMTConstraint" ],
    "available" : true,
    "active" : true,
    "name" : "operator"
  }, {
...
insert into config.DatagridSetting(dataGridSettingId,searchName,data,created,inputUserGroupId,inputUserId,inputSourceId) values 
('EventDefinition_Add_parameter','RestEventDefinition','{
  "dataTableName" : "testrunner.RestEventDefinition",
  "aSName" : "RestEventDefinition",
  "columnConfigurations" : [ {
    "name" : "eventTypeId",
    "hidden" : false,
    "available" : true,
...
ALTER TABLE permission.Permission ADD CONSTRAINT FK_permission_Permission_permissionTypeId FOREIGN KEY(permissionTypeId)  REFERENCES permission.EnuPermissionType(permissionTypeId)
; -- Generated Statement 

ALTER TABLE permission.Permission ADD CONSTRAINT FK_permission_Permission_permissionValueId FOREIGN KEY(permissionValueId)  REFERENCES permission.EnuPermissionValue(permissionValueId)
; -- Generated Statement 

ALTER TABLE permission.RolPermission ADD CONSTRAINT FK_permission_RolPermission_rolId FOREIGN KEY(rolId)  REFERENCES permission.Rol(rolId)
; -- Generated Statement 

ALTER TABLE permission.RolPermission ADD CONSTRAINT FK_permission_RolPermission_permissionId FOREIGN KEY(permissionId)  REFERENCES permission.Permission(permissionId)
; -- Generated Statement 

ALTER TABLE permission.UserGroupRol ADD CONSTRAINT FK_permission_UserGroupRol_rolId FOREIGN KEY(rolId)  REFERENCES permission.Rol(rolId)
; -- Generated Statement 

ALTER TABLE permission.UserGroupRol ADD CONSTRAINT FK_permission_UserGroupRol_inputUserGroupId FOREIGN KEY(inputUserGroupId)  REFERENCES audit.InputUserGroup(inputUserGroupId)
; -- Generated Statement 
...
ALTER TABLE recorder.RecorderData ADD CONSTRAINT FK_recorder_RecorderData_recorderTypeId FOREIGN KEY(recorderTypeId)  REFERENCES recorder.EnuRecorderType(enuRecorderTypeId)
; -- Generated Statement 
...
--- Start Dependency file: /poyake-permission/src/main/resources/metadata/permission/view/VRolLink.sql ---------------
...
--- End of Dependency file: /poyake-permission/src/main/resources/metadata/permission/view/VRolLink.sql

; -- Generated Statement 

--- Start Dependency file: /poyake-permission/src/main/resources/metadata/permission/view/VPermissionRol.sql ---------------
...
--- End of Dependency file: /poyake-permission/src/main/resources/metadata/permission/view/VPermissionRol.sql
...
--- Start Dependency file: /poyake-permission/src/main/resources/metadata/permission/view/VgroupRol.sql ---------------
...
--- End of Dependency file: /poyake-permission/src/main/resources/metadata/permission/view/VgroupRol.sql
...
--- Start Dependency file: /poyake-permission/src/main/resources/metadata/permission/view/Vpermission.sql ---------------
...
--- End of Dependency file: /poyake-permission/src/main/resources/metadata/permission/view/Vpermission.sql
...
--- Start Dependency file: /poyake-permission/src/main/resources/metadata/permission/view/VRolGroup.sql ---------------
...
from 
permission.rol r
--- End of Dependency file: /poyake-permission/src/main/resources/metadata/permission/view/VRolGroup.sql
