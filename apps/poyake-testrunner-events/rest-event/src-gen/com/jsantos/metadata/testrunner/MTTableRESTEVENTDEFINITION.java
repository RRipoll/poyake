...
public class MTTableRESTEVENTDEFINITION extends com.jsantos.orm.mt.MTTable{
	...
	public static final MTField HTTPMETHOD = new MTField("httpMethod");
	public static final MTField PARAMETERS = new MTField("parameters");
	public static final MTField JSON = new MTField("json");
	...
	public static void init(){
		...
		fields.add(EVENTDEFINITIONUUID);
		{
			...
			EVENTDEFINITIONUUID.setSequence("testrunner.Seq_RestEventDefinition_eventDefinitionUuid");
		...
		fields.add(URL);
		{
			URL.setDataType(MTDataTypes.VARCHAR);
			URL.setLength(255);
		...
		{
			HTTPMETHOD.setDataType(MTDataTypes.INT);
			HTTPMETHOD.setNullable(false);
			HTTPMETHOD.setTransient(false);
			HTTPMETHOD.setDefaultValue("1");
		}
		fields.add(PARAMETERS);
		{
			PARAMETERS.setDataType(MTDataTypes.PARAMETER);
			PARAMETERS.setNullable(true);
			PARAMETERS.setTransient(false);
		}
		fields.add(JSON);
		{
			JSON.setDataType(MTDataTypes.JSON);
			JSON.setLength(-1);
			JSON.setNullable(true);
			JSON.setTransient(false);
		}
	}

	public MTTableRESTEVENTDEFINITION(){
		init();
		this.tableName = "RestEventDefinition";
