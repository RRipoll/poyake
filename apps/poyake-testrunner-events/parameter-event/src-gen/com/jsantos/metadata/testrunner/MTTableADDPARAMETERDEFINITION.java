...
public class MTTableADDPARAMETERDEFINITION extends com.jsantos.orm.mt.MTTable{
	...
	public static void init(){
		...
		fields.add(EVENTDEFINITIONUUID);
		{
			...
			EVENTDEFINITIONUUID.setSequence("testrunner.Seq_AddParameterDefinition_eventDefinitionUuid");
	...
	public MTTableADDPARAMETERDEFINITION(){
		init();
		this.tableName = "AddParameterDefinition";
